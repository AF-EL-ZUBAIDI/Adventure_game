...
public class Ihm {
    ...
    /**
     * Foncyion qui récupère ce que le joueur veut déoser comme objet.
     * @return
     */
    public int deposeObjet(int indiceMax) {
        ...
        while (coup < 0 || coup > indiceMax) {
            System.out.println("\nQuel objet voulez-vous deposer ?\n" +
                    "Veuillez donner l'indice de l'objet que vous voulez déposé (commence par 0) : ");
            if (sc.hasNextInt()) {
                coup = sc.nextInt();
            } else {
                sc.next();
    ...
    /**
     * Fonction qui permet de recupéré le choix du joueur pour l'emplacement de l'objet qu'il veut déposé.
     * @return
     */
    ...
    /**
     * Fonction qui affiche que le personnage ne peut pas frapper.
     */
    public void pasFrapper() {
        System.out.println("Vous ne pouvez pas frappez.\n");
    }


    /**
     * Fonction qui affiche que le personnage a frappé un animal ami.
     */
    public void frapperPasAmi() {
        System.out.println("Vous avez frappez un animal qui n'est pas votre ami, il devient junkie.\n");
    }


    /**
     * Fonction qui affiche que le personnage a frappé un animal.
     */
    public void frapperAnimal() {
        System.out.println("Vous avez frappez votre animal de compagnie, il n'est plus votre ami.\n");
    }
